  ...
  return (
    <header className="navbar bg-dark p-1 d-flex justify-content-between align-items-center fixed-top">
      <div className="d-flex align-items-center gap-2">
        <i className="bi bi-geo-alt-fill" style={{ fontSize: "2rem", color: "cornflowerblue" , marginBottom: "0.5rem", marginLeft: "1rem"}}></i>
        <span className="fw-bold text-white"><h2>Places</h2></span>
